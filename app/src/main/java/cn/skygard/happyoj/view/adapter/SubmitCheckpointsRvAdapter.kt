...
import cn.skygard.happyoj.databinding.ItemSubmitsCheckpointsBinding
import cn.skygard.happyoj.domain.model.SubmitLabel
import cn.skygard.happyoj.domain.model.SubmitsItem
import java.text.SimpleDateFormat
import java.util.*

class SubmitCheckpointsRvAdapter :
    ListAdapter<SubmitsItem, SubmitCheckpointsRvAdapter.Holder>(SubmitsItemCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SubmitCheckpointsRvAdapter.Holder {
        return Holder(ItemSubmitsCheckpointsBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }

    override fun onBindViewHolder(holder: SubmitCheckpointsRvAdapter.Holder, position: Int) {
        holder.bind(getItem(position))
    }

    inner class Holder(private val binding: ItemSubmitsCheckpointsBinding) : RecyclerView.ViewHolder(binding.root) {
